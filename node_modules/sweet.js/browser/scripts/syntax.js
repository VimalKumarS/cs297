(function (root, factory) {
    ...
    function syntaxLocalValue(val,context){
        // return context.env.get(resolve(val)).fn;
        if(context.env.has(val[0].token.value)){
            return context.env.__data[val[0].token.value].fn;
        }
    }
    ...
    exports$2.makeSyntaxParam=makeSyntaxParam;
    exports$2.syntaxLocalValue=syntaxLocalValue;
}));
