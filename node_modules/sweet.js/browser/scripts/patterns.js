        ...
        return _.chain(macroBody).reduce(function (acc, bodyStx, idx, original) {
            ...
            if (bodyStx.repeat) {
               ...
               // push.apply(acc, joinRepeatedMatch(env[bodyStx.token.value].match, bodyStx.separator));
                ...
                {
                    var  newStxValue= joinRepeatedMatch(env[bodyStx.token.value].match, bodyStx.separator)
                    newStxValue= syntaxParamMatch(newStxValue,parser.syntaxParameter[macroNameStx.token.value],env);
                    push.apply(acc, newStxValue);
                }
                else{ //added
                    //true
                    push.apply(acc, joinRepeatedMatch(env[bodyStx.token.value].match, bodyStx.separator));
                ...
                if (bodyStx.token.type === parser.Token.Delimiter) {
                  ...
                  //added new code
                    if(parser.syntaxParameter[macroNameStx.token.value] != undefined)
                    {
                        newBody.token.inner= syntaxParamMatch(newBody.token.inner,parser.syntaxParameter[macroNameStx.token.value],env);
                    }
